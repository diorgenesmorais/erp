...
/**
 * A classe {@code WebConfig} é uma classe de configuração - substitui a web.xml
 * 
 * @author Diorgenes Morais
 * @see com.dms.erp.controller.CervejasController#pesquisar() motivo da anotação
 *      {@code EnableSpringDataWebSupport}
 *
 */
@Configuration
...
public class WebConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
	...
	public TemplateEngine templateEngine() {
		...
		/**
		 * @see Thymeleaf - Extras Spring Security: exibir o usuário logado.
		 */
	...
	/**
	 * This method allows automatic conversion of domain objects. (example:
	 * {@link com.dms.erp.controller.VendasController#removerItem(com.dms.erp.model.Cerveja)}
	 * ) Dependency of {@link WebConfig#mvcConversionService()} method as
	 * internal parameter.
	 * 
	 * @return {@code DomainClassConverter<FormattingConversionService>}
	 */
	@Bean
